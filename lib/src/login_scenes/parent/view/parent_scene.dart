...
class ParentScene extends StatelessWidget {
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => ParentScene());
  }
          ...
          body: Column(
            ...
            children: [
              Padding(
                ...
                child: Center(
                  child: Image.asset(
                    "assets/images/parent/parent_login.png",
                    fit: BoxFit.cover,
                    width: 141.w,
                    height: 96.h,
                  ),
