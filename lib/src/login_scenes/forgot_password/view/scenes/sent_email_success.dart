...
class SentEmailSuccess extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: BaseText(
                          text: state.resentEmail ? s.resent_email_succefully :s.email_was_send_succesfully,
                          type: TextTypes.h3,
                      ...
                      RichText(
                          text: TextSpan(
                              text: s.email_sent_succesfully_description_1,
                              ...
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                    text: s
                                        .email_sent_succesfully_description_2,
                                    style: defaultTextStyles[TextTypes.p2]
                                        .copyWith(
                                      color: AntColors.gray8,
                                    )),
